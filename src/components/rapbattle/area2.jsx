...
export const Area2 = ({ submittedUrls }) => {
  ...
  return (
    <div className="mt-[600px] pb-20 max-[768px]:pb-28 max-[480px]:pb-16 mx-auto w-[calc(100vw-160px)] max-w-[calc(1920px-160px)] max-[768px]:w-[calc(100vw-112px)] max-[480px]:w-[calc(100vw-64px)] min-[1920px]:w-[1920px] min-[1920px]:mx-auto flex flex-col gap-10 max-[480px]:gap-8">
      {loading && (
      ...
      {result && (
        <>
          <div className="flex gap-8 max-[812px]:flex-col max-[812px]:gap-8">
            <div className="flex-1 min-w-0 flex flex-col gap-10 max-[812px]:gap-8">
              <TitleAndArtist
