  ...
  return (
    <div className="min-[1920px]:w-[1920px] min-[1920px]:justify-self-center mt-[10vh]">
      ...
      <div className="z-10 absolute justify-self-center top-48 w-full max-w-[1920px]">
        ...
        <h3 className="text-h3 text-black text-center py-8">
          VS
        </h3>
        ...
        <button
          ...
          className="bg-black h-10 flex w-[222px] mx-auto mt-6 justify-center"
        >
          <p className="text-p text-white">Enter</p>
        </button>
        ...
        {result && (
          <div className="text-white text-center mt-5">
            ...
            <p>
              Diff Average: {result.comparison.averageDifference}
            </p>
          </div>
        )}
