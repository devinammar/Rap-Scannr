      ...
      <div className="flex px-20 max-[768px]:px-14 max-[480px]:px-8 pt-15 max-[768px]:justify-between max-[768px]:flex-col">
        <div className="flex gap-16 order-1 max-[768px]:order-1 max-[768px]:pb-10 items-start">
          <button className="w-16 group" onClick={prev}>
            <img src="/previous.png" className="block group-hover:hidden" alt="previous" />
            <img src="/previousgrey.png" className="hidden group-hover:block" alt="previous" />
          </button>
          <button className="w-16 group" onClick={next}>
            <img src="/next.png" className="block group-hover:hidden" alt="next" />
            <img src="/nextgrey.png" className="hidden group-hover:block" alt="next" />
          </button>
        </div>
