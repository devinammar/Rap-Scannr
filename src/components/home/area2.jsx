    ...
    <div className="mt-0">
      ...
      <div>
        <p>
          ...
          how rhythm, pacing, and syllable patterns shape each performance. From
          speed detection to track comparison, Rap Scannr helps listeners
        ...
        <h2>Visualize and see the rhythm behind every rap verse</h2>
      </div>
    </div>
  );
};
