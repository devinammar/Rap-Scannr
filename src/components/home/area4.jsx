...
export const Area4 = () => {
  const card1 =
    "relative w-90 max-[940px]:w-full h-[560px] max-[940px]:h-[400px] bg-cover bg-bottom group overflow-hidden";
  const card2 =
    "relative w-90 max-[940px]:w-full h-[560px] max-[940px]:h-[400px] bg-cover bg-center group overflow-hidden";
  const cardhover =
  ...
  return (
    <div className="min-[1920px]:w-[1920px] min-[1920px]:justify-self-center grid justify-items-end mt-62 max-[1024px]:mt-52 max-[768px]:mt-46 px-20 max-[768px]:px-14 max-[480px]:px-8 max-[1192px]:w-fit max-[1192px]:justify-self-end max-[940px]:w-full max-[940px]:justify-self-stretch">
      <motion.h2
        {...scrollProps}
        variants={fadeRight}
        className="text-h2 max-[640px]:text-h2-2 max-[320px]:text-h2-3 text-black font-medium pb-7"
      >
        Our Features
      </motion.h2>
      <motion.div {...scrollProps}
          variants={zoomIn} className="flex flex-nowrap items-end max-[1192px]:flex-wrap max-[940px]:w-full">
        <Link
          to="/trackanalysis"
          className="order-2 pr-15 max-[1192px]:order-1 max-[940px]:w-full max-[940px]:pr-0 max-[940px]:pb-16 max-[768px]:pb-12 max-[520px]:pb-9"
        >
          <div
            className={card1}
            style={{
          ...
          >
            ...
            <div className={cardhovertext}>
              <p className="text-white text-p">
                Dive deeper into every verse and uncover the rhythm behind each
                performance with. <br />
                <br /> Interactive insights designed to highlight flow, pacing,
                and lyrical delivery in a clear and engaging way, making every
                track easier to explore and appreciate.
              </p>
            </div>
            <h3 className="text-h3 text-white font-medium px-8 pb-14 absolute bottom-0 z-10">
              Track Analysis
            </h3>
          </div>
        </Link>
        <Link
          to="/rapbattle"
          className="order-3 max-[1192px]:order-2 max-[940px]:w-full"
        >
          <div
            className={card2}
            style={{
          ...
          >
            ...
            <div className={cardhovertext}>
              <p className="text-white text-p">
                Put two rap performances side by side and discover how each
                artist stands out with. <br />
                <br /> Interactive comparisons that reveal differences in flow,
                rhythm, and delivery, offering a fresh perspective through a
        ...
        <motion.p
          {...scrollProps}
          variants={fadeLeft}
          className="max-w-[580px] text-p order-1 mr-auto pr-19 max-[1192px]:order-3 max-[1192px]:pt-15 max-[1192px]:mr-0 max-[1192px]:hidden"
        >
          From single-track discoveries to head-to-head exploration, our
          interactive features are built to help you experience rap in a more
      ...
      <motion.p
        {...scrollProps}
        variants={fadeLeft}
        className="max-w-[580px] text-p order-1 mr-auto max-[460px]:pr-12 pr-19 hidden max-[1192px]:block max-[1192px]:order-3 max-[1192px]:pt-15"
      >
        From single-track discoveries to head-to-head exploration, our
        interactive features are built to help you experience rap in a more
        engaging and meaningful way.
