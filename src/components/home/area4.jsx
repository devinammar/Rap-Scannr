...
export const Area4 = () => {
  return (
    <div className="min-[1920px]:w-[1920px] min-[1920px]:justify-self-center grid justify-items-end mt-[248px] px-20 max-[768px]:px-14 max-[480px]:px-8 max-[1192px]:w-fit max-[1192px]:justify-self-end">
        <h2 className="text-h2 text-black font-medium pb-7">Our Features</h2>
        <div className="flex flex-nowrap items-end max-[1192px]:flex-wrap">
        <Link className="order-2 pr-15 max-[1192px]:order-1">
        ...
        <Link className="order-3 max-[1192px]:order-2">
