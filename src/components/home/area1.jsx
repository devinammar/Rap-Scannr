  ...
  return (
    <div className="min-[1920px]:w-[1920px] min-[1920px]:justify-self-center">
      <div className="relative h-[60vh] max-h-[768px]">
        ...
        <div className="absolute top-full -translate-y-[30%] [@media(min-height:800px)]:-translate-y-[24%] justify-self-center w-[calc(100vw-160px)] max-w-[calc(1920px-160px)]">
          <h1 className="[grid-area:h1] text-h1 font-medium mb-3">Rap Scannr</h1>
          <p className="[grid-area:p] text-p text-black w-[572px] mb-8 [@media(min-height:800px)]:mb-33">
